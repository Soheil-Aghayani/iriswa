---
title: "جلسه بیست و سوم: مدیریت بهداشت و محیط زیست در شرایط اضطراری (۳)"
date: "2026-04-29"
image: "./assets/images/news/hse-emergency-session23.jpg"
...
شرکت مدیریت پسماند شیمی کشاورز با همکاری انجمن علمی مهندسی و مدیریت پسماند ایران، در راستای صیانت از محیط زیست و پاسخی ملی به چالش‌های جهانی، <strong>جلسه بیست و سوم</strong> از سلسله دوره‌های آموزشی مدیریت پسماند را با موضوع <em>«مدیریت بهداشت و محیط زیست در شرایط اضطراری (۳)»</em> برگزار می‌کند.
</p>
...
<ul style="font-size: 1.1rem; line-height: 2.2; list-style-type: square; padding-right: 20px; margin-bottom: 30px;">
    <li><strong>تاریخ برگزاری:</strong> چهارشنبه ۹ اردیبهشت‌ماه ۱۴۰۵</li>
...
<script>
    function updateCourseStatus() {
        ...
        // زمان شروع و پایان جلسه بیست و سوم (9 اردیبهشت 1405 معادل 29 آوریل 2026)
        const startTime = new Date('2026-04-29T19:00:00+03:30').getTime();
        const endTime = new Date('2026-04-29T21:00:00+03:30').getTime();
